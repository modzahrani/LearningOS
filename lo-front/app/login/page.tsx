...
import { login, startOAuthLogin, type OAuthProvider } from "@/api/userProvider";
...
export default function LoginPage() {
  ...
  const handleOAuthLogin = async (provider: OAuthProvider) => {
    ...
    try {
      ...
      setError(
        getFriendlyError(err, "Unexpected error while starting social login. Please try again.")
      );
      ...
      >
        ...
        <circle cx="12" cy="12" r="3" />
          ...
          <div className="links">
            ...
            <p className="create-account" onClick={() => router.push("/forgot-password")}>
              Forgot password?
            </p>
          </div>
